...
def assert_and_infer_cfg(cfg, args):
    ...
    if cfg.MODEL.MODEL_NAME in ['LSTR']:
        ...
        cfg.MODEL.LSTR.FUTURE_LENGTH = cfg.MODEL.LSTR.FUTURE_SECONDS * cfg.DATA.FPS
        ...
        cfg.MODEL.LSTR.FUTURE_NUM_SAMPLES = cfg.MODEL.LSTR.FUTURE_LENGTH // cfg.MODEL.LSTR.FUTURE_SAMPLE_RATE

        assert cfg.MODEL.LSTR.INFERENCE_MODE in ['batch', 'stream']
        # print(cfg.MODEL.LSTR.FUT_MODULE[0][0] , cfg.MODEL.LSTR.FUTURE_NUM_SAMPLES)
        assert cfg.MODEL.LSTR.FUT_MODULE[0][0] == cfg.MODEL.LSTR.FUTURE_NUM_SAMPLES
